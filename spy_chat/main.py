from spy_details import spy, Spy, ChatMessage, friends                  #this statement import the spy chatmessage and friend from spy detail...
...
def add_a_friend():             # here  'add_a_friend()' is also a func. name... for add a new friend..
...
def select_a_friend():           # here  'select_a_friend()' is also a func. name... for select a friend..
    ...
    return friend_choice_position                   # ehis statement return the value of 'friend_choice_position' ......
        ...
        while show_menu:
            ...
            if len(menu_choice) > 0 and len(menu_choice)<8:        #  if len(menu_choice) > 0 and len(menu_choice)<8, tan execute other wise not.....
                ...
                if menu_choice == 1:
                    ...
                    number_of_friends = add_a_friend()                                   # call the ' add_a_friend() '   and returend in to a 'number_of_friends'..
...
if existing.upper() == "Y":
    ...
    print"Please enter a correct choice either 'Y' or 'N'!!!"